...
const ERDEditor: React.FC<ERDEditorProps> = ({ initialNodes, initialEdges, projectId }) => {
  ...
  const [selectedTable, setSelectedTable] = useState<ERDEditorProps['availableTables'][0] | null>(null);
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="p-4 bg-gray-100 shadow-md flex items-center space-x-4">
        <Button
